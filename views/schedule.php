...
<section class="container page-content event-content txt-center">
    ...
    <div class="event">
        <div class="event-header">
            <h2>Tea Ceremony</h2>
            <h5>Saturday, September 28<sup>th</sup>, 2019</h5>
            <h5>10:00 AM - 12:00 PM</h5>
        </div>
        <div class="event-divider">
            <i class="ico-champagne-1"></i>
        </div>
        <div class="event-info">
            <h3>The Duong Residence</h3>
    ...
    <div class="event">
        ...
        <div class="event-divider">
            <i class="ico-wedding"></i>
        </div>
        <div class="event-info">
            <h3>St. Christopher Church</h3>
    ...
    <div class="event">
        <div class="event-header">
            <h2>Reception</h2>
            <h5>Saturday, September 28<sup>th</sup>, 2019</h5>
            <h5>6:00 PM - 11:00 PM</h5>
        </div>
        <div class="event-divider">
            <i class="ico-cake"></i>
        </div>
        <div class="event-info">
            <h3>Diamond Seafood #3</h3>
            <h5>6731 Westminster Blvd</h5>
            <h5>Westminster, CA 92683</h5>
            <p>
                Cocktail Hour starts at 6:00 PM<br/>
